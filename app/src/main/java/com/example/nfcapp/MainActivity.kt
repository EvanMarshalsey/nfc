...
public class MainActivity : AppCompatActivity, CompoundButton.OnCheckedChangeListener, NfcAdapter.ReaderCallback {
    ...
    private val nfcSharedViewModel: NfcSharedViewModel by viewModels()
    ...
    override fun onTagDiscovered(tag : Tag?) {
        ...
        binder?.getViewModel()?.readNfcTag(this, tag)
        //if (tag != null) {
        //    nfcSharedViewModel.setNfcTag(tag) // Store the detected NFC tag
        //}
    }
